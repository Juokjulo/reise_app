Rails.application.routes.draw do
  ...
  get "pictures/show/country/:id/:country" => "pictures#show", :as => "show_picture_country" 
  get "pictures/show/tag/:id/:tag" => "pictures#show", :as => "show_picture_tag" 
  get "pictures/show/date/:id/:date" => "pictures#show", :as => "show_picture_date" 
